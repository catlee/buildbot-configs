...
PLATFORMS['macosx']['leopard-o'] = {'name': builder_prefix +
...
PLATFORMS['macosx64']['leopard'] = {'name': builder_prefix +
                                    "Rev3 MacOSX Leopard 10.5.8"}
PLATFORMS['macosx64']['snowleopard'] = {'name': builder_prefix +
                                        "Rev4 MacOSX Snow Leopard 10.6"}
PLATFORMS['macosx64']['lion'] = {'name': builder_prefix +
                                 "Rev4 MacOSX Lion 10.7"}
PLATFORMS['macosx64']['mountainlion'] = {'name': builder_prefix +
...
PLATFORMS['win32']['mozharness_python'] = [
    'c:/mozilla-build/python25/python', '-u']
...
PLATFORMS['linux64']['fedora64'] = {'name': builder_prefix +
                                    "Rev3 Fedora 12x64"}
...
OLD_BRANCH_NO_WIN = PLATFORMS['macosx']['slave_platforms'] + PLATFORMS[
    'linux']['slave_platforms']

OLD_BRANCH_NO_MAC = PLATFORMS['linux']['slave_platforms'] + PLATFORMS[
    'win32']['slave_platforms']
