...
releaseConfig[
    'stagingServer'] = 'preproduction-stage.srv.releng.scl3.mozilla.com'
releaseConfig[
    'ausServerUrl'] = 'http://preproduction-stage.srv.releng.scl3.mozilla.com'
...
releaseConfig[
    'ftpServer'] = 'preproduction-stage.srv.releng.scl3.mozilla.com'
